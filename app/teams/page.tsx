  ...
  const teams = [
    {
      ...
      achievements: [
        ...
        {
          titlePt: "Rookie Inspiration Award",
          titleEn: "Rookie Inspiration Award",
        },
        {
    ...
    },
    {
      ...
      period: "2018 - 2021",
      descriptionPt:
        "Equipe de alta performance especializada em robótica autônoma e inteligência artificial. Focamos em competições de nível mundial e desenvolvimento de tecnologias emergentes.",
      descriptionEn:
        "High-performance team specialized in autonomous robotics and artificial intelligence. We focus on world-level competitions and development of emerging technologies.",
      image: "/autonomous-robot-team.png",
      logo: "/logos/logo-pequeno-gigante.png",
      achievements: [
        {
          titlePt: "3º Lugar - Campeonato Mundial",
          titleEn: "3rd Place - World Championship",
        },
        {
          titlePt: "1º Lugar - Torneio Regional",
          titleEn: "1st Place - Regional Tournament",
        },
        {
          titlePt: "Melhor Algoritmo - Nacional",
          titleEn: "Best Algorithm - National",
        },
      ],
    },
  ]
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="w-full bg-background/80 backdrop-blur-md shadow-md fixed top-0 left-0 right-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <Link href="/achievements" className="text-2xl font-bold text-primary">
